        ...
        try:
            ...
            if x["cod"] != "404":
                ...
                if id == "800":
                    ...
                    self.root.ids.weather_image.source = "assets/rainfall.png"
                elif "600" <= id <= "622":
...
if __name__ == '__main__':
    LabelBase.register(name="Poppins", fn_regular="C:\\Users\\Tshiamo\\Desktop\\kivy projects\\WeatherApp\\assets\\Poppins\\Poppins-Medium.ttf")
    LabelBase.register(name="BPoppins", fn_regular="C:\\Users\\Tshiamo\\Desktop\\kivy projects\\WeatherApp\\assets\\Poppins\\Poppins-SemiBold.ttf")
    WeatherApp().run()
